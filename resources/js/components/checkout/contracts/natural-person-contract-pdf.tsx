...
interface NaturalPersonContractPdfProps {
...
export function NaturalPersonContractPdf({
    data,
    plan,
    logoSource,
...
export function getNaturalPersonContractContent(
    ...
    const clauses: ContractClause[] = [
        ...
        },
        {
            ...
            paragraphs: [
                ...
                'El aviso deberá ser enviado por el sub-Arrendador al sub-Arrendatario, o por el sub-Arrendatario al sub-Arrendador, según corresponda, por el medio más expedito posible, con una anticipación mínima de 45 días de cualquiera de sus periodos de Pago, la fecha de vencimiento original o cualquiera de sus renovaciones si las hubiere. Verificado el aviso, el arrendatario estará obligado a realizar el cambio de domicilio correspondiente en el servicio de impuestos internos y la patente comercial en la Ilustre Municipalidad de Providencia asociada a su razón social, hasta antes del día de término del arriendo.',
                'Si el sub-arrendatario no realiza el cambio de domicilio tributario y de patente comercial, dará derecho al Arrendador para seguir cobrando el monto de arriendo inicialmente pactado.',
            ],
        },
        {
        ...
        },
        {
            ...
            paragraphs: [
                'Para todos los efectos legales derivados del presente contrato, la partes fijan domicilio en la Región Metropolitana y Región de Magallanes, y se someten a la competencia de sus tribunales de justicia.',
    ...
    return {
        introduction,
        clauses,
        subject: `Contrato persona natural - Plan ${plan.name}`,
    };
}
