        ...
        >
            ...
            <div className="mt-8 space-y-10">
                <FormSection
                    ...
                    description="Ingresa los datos personales del representante legal de la empresa."
                >
                ...
                <FormSection
                    ...
                    description="Estos datos aparecerán en el contrato de oficina virtual."
                >
                    <div className="grid gap-x-6 gap-y-6 md:grid-cols-2">
                        <FormField
            ...
            {data.company_in_progress && (
                <div className="mt-8 border-l-4 border-instinct bg-instinct/7 px-5 py-5">
                    <p className="text-sm leading-6 text-deep-blue/70">
                        Como tu empresa aún no cuenta con RUT, no avanzarás a
                        la previsualización del contrato. La información será
                        enviada a nuestro equipo y un ejecutivo se pondrá en
        ...
        <div className={className}>
            ...
            <input
                ...
                className={[
                    ...
                    'disabled:cursor-not-allowed disabled:bg-deep-blue/5 disabled:text-deep-blue/40',
                    error
